...
2. Write the name of your group members here: Myself(Dennis Chase), Raiven Johnson and Leo Lara
...
Write the URL for your personal fork of the repository here: https://github.com/dchase3/Project2-Group
...
Write the output of `git remote -v` from your copy of the forked repository here: origin git@github:dchase3/Project2-Group.git (fetch)
                                                                                  git@github:dchase3/Project2-Group.git (fetch)
...
Write the URL of your pull request here: https://github.com/itmd362-RJDCLL/Project2-Group/compare/master...dchase3:master
